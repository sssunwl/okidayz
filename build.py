...
def build_news(news):
    ...
    render_page("news", main, "沖繩新聞・日本大事｜OkiDayz",
...
def build_month_pages(months):
    ...
    for month in months:
        ...
        canonical = render_page(
            ...
            "{}｜OkiDayz".format(month.get("title", "")),
            str(month.get("blurb", "")),
            active="guide",
...
def build_toolkit():
    ...
    render_page("toolkit", main, "旅行小抄｜OkiDayz",
